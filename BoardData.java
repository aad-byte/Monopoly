...
public class BoardData {
	public static BoardTile[][] tiles = new BoardTile[9][]; //5 types of properties, Train Station, Generic Squares, Jail tile, chance tile
    ...
    public static BoardTile[][] getBoardTiles() {
    	return tiles;
    }
}
